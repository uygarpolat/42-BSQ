Python solution for 42 Piscine's BSQ project where you try to find the largest square that can fit in a grid, without intersecting any of the obstacles contained in it.
